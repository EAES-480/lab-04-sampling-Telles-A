...
> Seasonality is important for sampling because within the environment, changes in seasons can account for a lot of variability within a system. If sampling ignores latent grouping variables, there can be parts of the data that remains unexplained. In EaES, stratification is essential when there are distinct sub-groups that need to be represented. However, with stratified samplinga, the trade-off is the complexity it adds to a data set (vs. simple random sampling). 
